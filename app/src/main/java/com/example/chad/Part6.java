...
public class Part6 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD22A")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part6.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part6.this);
        fab.setId(R.id.fab);
                    ...
                    if (extras.containsKey("FILENAME")) {
                        ...
                        try {
                            ...
                            for(int i=0; i<array_results.length(); i++){
                                ...
                                if(object1.getString("code").equals("CHAD22A")){
                            ...
                            if (fdelete.exists()) {
                                if (fdelete.delete()) {
                                    ...
                                    try {
                                        ...
                                        //Toast.makeText(Part6.this, "Data updated", Toast.LENGTH_LONG).show();
                        ...
                        general.AddObjectToResultArray("CHAD22A", answer_code, Part6.this);
                        Intent intent = new Intent(Part6.this, Part28.class);
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part6.this);
                RadioButton spinner;
                    ...
                    if (extras != null) {
                        if (extras.containsKey("FILENAME")) {
                            ...
                            for (int k = 0; k < array_results.length(); k++) {
                                ...
                                if (opt_data_results.getString("code").equals("CHAD22A")) {
        ...
        if (extras != null) {
                                ...
                                if (fdelete.exists()) {
                                    if (fdelete.delete()) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(Part6.this, R.string.dataupdated, Toast.LENGTH_LONG).show();

                                            Intent intent = new Intent(Part6.this, Dashboard.class);
            ...
            btn_back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    general.goBackDialoag(Part6.this);
                }
            });
    ...
    public void finishDialog(final String filename, final String string_object_answers) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Part6.this);
        ...
        builder.setPositiveButton(R.string.save,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        filling.saveFileToFolderContext2(filename, string_object_answers, Part6.this);
                    }
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part6.this)
