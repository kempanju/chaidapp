...
public class Part26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part26.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part26.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answer_code.equals("CHAD20A")){
                    general.CreateSmallObjectForMainObjectInt(Part26.this, "pregnant_woman", "child_aged_under_one", 1);
                    //general.AddObjectToResultArray("CHAD20", answer_code, Part26.this);
                }else{
                    general.CreateSmallObjectForMainObjectInt(Part26.this, "pregnant_woman", "child_aged_under_one", 0);
                    //general.AddObjectToResultArray("CHAD20", answer_code, Part26.this);
                }
                Intent intent = new Intent(Part26.this, Part27.class);
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part26.this);
                RadioButton spinner;
...
/*            ArrayAdapter arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, personNames);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part26.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part26.this)
