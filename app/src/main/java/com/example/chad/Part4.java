...
public class Part4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part4.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part4.this);
        fab.setId(R.id.fab);
            ...
            public void onClick(View view) {
                if (extras != null) {
                    if (extras.containsKey("FILENAME")) {
                                ...
                                if (fdelete.exists()) {
                                    if (fdelete.delete()) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(Part4.this, R.string.dataupdated, Toast.LENGTH_LONG).show();

                                            string_object_answers = object_answers.toString();
                                            Intent intent = new Intent(Part4.this, Part17.class);
                        ...
                        String ans = answer_code.toString().replaceAll("[\\[\\](){}]","").trim();
                        general.AddObjectToResultArray("CHAD18C", ans.trim(), Part4.this);
                        if(answer_code.size() > 0){
                            dangerDialog();
                        }else{
                            Intent intent = new Intent(Part4.this, Part17.class);
                        ...
                        if (extras != null) {
                            if (extras.containsKey("FILENAME")) {
                                ...
                                for (int k = 0; k < array_results.length(); k++) {
                                    ...
                                    if (opt_data_results.getString("code").equals("CHAD18")) {
        ...
        if (extras != null) {
                                ...
                                if (fdelete.exists()) {
                                    if (fdelete.delete()) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(Part4.this, "Data updated", Toast.LENGTH_LONG).show();

                                            Intent intent = new Intent(Part4.this, Dashboard.class);
            ...
            btn_back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    general.goBackDialoag(Part4.this);
                }
            });
    ...
    public void dangerDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Part4.this);
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part4.this)
