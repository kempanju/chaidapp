...
public class Part28 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD22B")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part28.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part28.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                general = new General(Part28.this);
                if(answer_code.equals("CHAD22B1")){
                    general.CreateSmallObjectForMainObjectInt(Part28.this, "pregnant_woman", "prefer_planning_after_delivery", 1);
                    //general.AddObjectToResultArray("CHAD22B", answer_code, Part28.this);
                    Intent intent = new Intent(Part28.this, Part53.class);
                    startActivity(intent);
                }else{
                    general.CreateSmallObjectForMainObjectInt(Part28.this, "pregnant_woman", "prefer_planning_after_delivery", 0);
                    //general.AddObjectToResultArray("CHAD22B", answer_code, Part28.this);
                    String chad16 = general.getFile("CHAD16", Part28.this);
                    ...
                    try {
                        ...
                        if(json_data.getString("breastfeeding_mother_above").equals("false")){
                                ...
                                if(json_data.getString("neonates").equals("false")){
                                    ...
                                    if(json_data.getString("infants").equals("false")){
                                        ...
                                        if(json_data.getString("children").equals("false")){
                                            //other services
                                            Intent intent = new Intent(Part28.this, Part14.class);
                                            ...
                                            filling.writeToFile("CHAD16", main_object.toString(), Part28.this);
                                            ...
                                            if(Title.equals("children")){
                                                ...
                                                Intent intent = new Intent(Part28.this, Part35.class);
                            ...
                            Intent intent = new Intent(Part28.this, Part9.class);
                            startActivity(intent);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part28.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part28.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part28.this)
