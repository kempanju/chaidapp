...
public class Part77 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD51B")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part77.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part77.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                general = new General(Part77.this);
                if(answer_code.equals("CHAD51B1")){
                    general.AddObjectToResultArray("CHAD51B", answer_code, Part77.this);
                    Intent intent = new Intent(Part77.this, Part78.class);
                    startActivity(intent);
                }else{
                    general.AddObjectToResultArray("CHAD51B", answer_code, Part77.this);
                    Intent intent = new Intent(Part77.this, Part79.class);
                    startActivity(intent);
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part77.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part77.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part77.this)
