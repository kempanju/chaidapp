...
public class Part84 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD55A")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part84.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part84.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                general = new General(Part84.this);
                if(answer_code.equals("CHAD55A1")){
                    general.AddObjectToResultArray("CHAD55A", answer_code, Part84.this);
                    Intent intent = new Intent(Part84.this, Part85.class);
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part84.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part84.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part84.this)
