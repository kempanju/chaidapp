...
public class Part19 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD32F")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part19.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part19.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                general.AddObjectToResultArray("CHAD32F", ans.trim(), Part19.this);
                String chad16 = general.getFile("CHAD16", Part19.this);
                            ...
                            if(json_data.getString("neonates").equals("false")){
                                ...
                                if(json_data.getString("infants").equals("false")){
                                    ...
                                    if(json_data.getString("children").equals("false")){
                                        //other services
                                        Intent intent = new Intent(Part19.this, Part14.class);
                                        ...
                                        filling.writeToFile("CHAD16", main_object.toString(), Part19.this);
                                        ...
                                        if(c.equals("true")){
                                            ...
                                            Intent intent = new Intent(Part19.this, Part35.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part19.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part19.this)
