...
public class Part35 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD26")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part35.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part35.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                general.CreateSmallObjectForMainObjectString(Part35.this, Title, "danger_sign", ans.trim());
                general.AddObjectToResultArray("CHAD26", ans.trim(), Part35.this);
                if(answer_code.size() > 0){
                    dangerDialog();
                }else{
                    Intent intent = new Intent(Part35.this, Part57.class);
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                for(int j=0; j<optArray.length(); j++){
                    final JSONObject opt_data = optArray.getJSONObject(j);
                        ...
                        checkbox[j] = new CheckBox(Part35.this);
    ...
    public void dangerDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Part35.this);
        ...
        builder.setPositiveButton(getString(R.string.submit), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(Part35.this, End.class);
                startActivity(intent);
            }
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part35.this)
