...
public class Part38 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD39")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part38.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part38.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                general = new General(Part38.this);
                String chad16 = general.getFile("CHAD16", Part38.this);
                JSONObject json = null;
                try {
                    json = new JSONObject(chad16);
                    JSONArray arrayChad16 = json.getJSONArray("CHAD16");
                    JSONObject json_data = arrayChad16.getJSONObject(2);
                    if(json_data.getString("breastfeeding_mother_below").equals("false")){
                        ...
                        if(json_data.getString("neonates").equals("false")){
                            ...
                            if(json_data.getString("infants").equals("false")){
                                ...
                                if(json_data.getString("children").equals("false")){
                                    //other services
                                    Intent intent = new Intent(Part38.this, Part14.class);
                                    ...
                                    filling.writeToFile("CHAD16", main_object.toString(), Part38.this);
                                    ...
                                    if(Title.equals("children")){
                                        ...
                                        Intent intent = new Intent(Part38.this, Part35.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part38.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part38.this)
