...
public class Part31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part31.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part31.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answer_code.equals("CHAD18D1")){
                    general.AddObjectToResultArray("CHAD18D", answer_code, Part31.this);
                    Intent intent = new Intent(Part31.this, Part25.class);
                    startActivity(intent);
                }else{
                    general.AddObjectToResultArray("CHAD18D", answer_code, Part31.this);
                    Intent intent = new Intent(Part31.this, Part32.class);
                    startActivity(intent);
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part31.this);
                RadioButton radioButton;
                    ...
                    for(int j=0; j<optArray.length(); j++){
                        ...
                        radioButton.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 90));
                        setMargins(radioButton, 0, 0, 0, 10);
                        radioButton.setText(opt_data.getString("name_en"));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part31.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part31.this)
