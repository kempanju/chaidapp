...
public class Part29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part29.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part29.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!answer_code.equals("")){
                    if(answer_code.equals("CHAD11A")){
                        general.AddObjectToResultArray("CHAD11", answer_code, Part29.this);
                        Intent intent = new Intent(Part29.this, Part40.class);
                        startActivity(intent);
                    }else{
                        general.AddObjectToResultArray("CHAD11", answer_code, Part29.this);
                        Intent intent = new Intent(Part29.this, Part3.class);
                        startActivity(intent);
                    }
                }else{
                    Toast.makeText(Part29.this, getResources().getString(R.string.please_select_objective), Toast.LENGTH_SHORT).show();
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                    ...
                    RadioGroup rg = new RadioGroup(Part29.this);
                    RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part29.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part29.this)
