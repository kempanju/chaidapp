...
public class Part74 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD49")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part74.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part74.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                general = new General(Part74.this);
                if(answer_code.equals("CHAD49A")){
                    general.AddObjectToResultArray("CHAD49", answer_code, Part74.this);
                    Intent intent = new Intent(Part74.this, Part75.class);
                    startActivity(intent);
                }else{
                    general.AddObjectToResultArray("CHAD49", answer_code, Part74.this);
                    Intent intent = new Intent(Part74.this, Part76.class);
                    startActivity(intent);
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part74.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part74.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part74.this)
