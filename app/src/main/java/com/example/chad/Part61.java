...
public class Part61 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD32E")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part61.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part61.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(answer_code.equals("CHAD32E1")){
                    general.AddObjectToResultArray("CHAD32E", answer_code, Part61.this);
                    Intent intent = new Intent(Part61.this, Part19.class);
                    startActivity(intent);
                }else if(answer_code.equals("CHAD32E2")){
                    general.AddObjectToResultArray("CHAD32E", answer_code, Part61.this);
                    Intent intent = new Intent(Part61.this, Part15.class);
                    startActivity(intent);
                }
            }
        });
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part61.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part61.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part61.this)
