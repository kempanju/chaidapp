...
public class Part85 extends AppCompatActivity {

    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD55B")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part85.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part85.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!answer_code.equals("")){
                    general.AddObjectToResultArray("CHAD55B", answer_code, Part85.this);
                    Intent intent = new Intent(Part85.this, End.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(Part85.this, getResources().getString(R.string.please_select_objective), Toast.LENGTH_SHORT).show();
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                    ...
                    RadioGroup rg = new RadioGroup(Part85.this);
                    RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part85.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part85.this)
