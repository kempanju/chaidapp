...
public class Part39 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD40")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part39.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part39.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String chad16 = general.getFile("CHAD16", Part39.this);
                String chad17 = general.getFile("CHAD17", Part39.this);
                JSONObject json = null;
                JSONObject json_neonates = null;
                JSONObject json_infants = null;
                JSONObject json_children = null;

                JSONObject json_adolescents_girls = null;
                JSONObject json_adolescents_boys = null;
                ...
                try {
                    ...
                    json_adolescents_girls = arrayChad16.getJSONObject(6);
                    json_adolescents_boys = arrayChad16.getJSONObject(7);

                    n = json_neonates.getString("neonates");
                    i = json_infants.getString("infants");
                    c = json_children.getString("children");
                    ag = json_adolescents_girls.getString("adolescents_girls");
                    ab = json_adolescents_boys.getString("adolescents_boys");
                } catch (JSONException e) {
                    e.printStackTrace();
                }

               // Toast.makeText(getApplicationContext(),ab+" - "+ag,Toast.LENGTH_LONG).show();
                ...
                if(n.equals("true") || i.equals("true") || c.equals("true")){
                            ...
                            if(json_data.getString("neonates").equals("false")){
                                ...
                                if(json_data.getString("infants").equals("false")){
                                    ...
                                    if(json_data.getString("children").equals("false")){
                                        //other services
                                        Intent intent = new Intent(Part39.this, Part14.class);
                                        ...
                                        filling.writeToFile("CHAD16", main_object.toString(), Part39.this);
                                        ...
                                        if(n.equals("false") && i.equals("false") && c.equals("true")){
                                            ...
                                            Intent intent = new Intent(Part39.this, Part35.class);
                    ...
                    Intent intent = new Intent(Part39.this, Part36.class);
                    startActivity(intent);
                }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part39.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part39.this)
