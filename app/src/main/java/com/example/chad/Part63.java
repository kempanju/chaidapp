...
public class Part63 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("CHAD33D")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part63.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part63.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(answer_code.equals("CHAD33D1")){
                    general.CreateMainObjectInt("care_giver", 1, Part63.this);
                    //general.AddObjectToResultArray("CHAD33A", answer_code, Part14.this);
                    Intent intent = new Intent(Part63.this, Part15.class);
                    intent.putExtra("TITLE", Title);
                    startActivity(intent);
                }else{
                    general.CreateMainObjectInt("care_giver", 0, Part63.this);
                    //general.AddObjectToResultArray("CHAD33A", answer_code, Part14.this);
                    Intent intent = new Intent(Part63.this, Part15.class);
                    intent.putExtra("TITLE", Title);
                    startActivity(intent);
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part63.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part63.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part63.this)
