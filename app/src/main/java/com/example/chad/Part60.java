...
public class Part60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part60.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part60.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answer_code.equals("CHAD32C1")){
                    general.CreateSmallObjectForMainObjectInt(Part60.this, "post_delivery", "take_child_clinic", 1);
                    general.CreateSmallObjectForMainObjectInt(Part60.this, "child_under_five", "take_child_clinic", 1);
                    //general.AddObjectToResultArray("CHAD32C", answer_code, Part60.this);
                    Intent intent = new Intent(Part60.this, Part13.class);
                    startActivity(intent);
                }else if(answer_code.equals("CHAD32C2")){
                    general.CreateSmallObjectForMainObjectInt(Part60.this, "post_delivery", "take_child_clinic", 0);
                    general.CreateSmallObjectForMainObjectInt(Part60.this, "child_under_five", "take_child_clinic", 0);
                    //general.AddObjectToResultArray("CHAD32C", answer_code, Part60.this);
                    Intent intent = new Intent(Part60.this, Part62.class);
                    startActivity(intent);
                }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part60.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part60.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part60.this)
