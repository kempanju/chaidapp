...
public class Part70 extends AppCompatActivity {
    private static final Set<String> CODES = Collections.unmodifiableSet(new HashSet<>(Collections.singletonList("CHAD45")));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String questions = general.getFile("questionnaire", Part70.this);
        try {
    ...
    public void createAQuestion(String questions) throws JSONException {
        ...
        FloatingActionButton fab = new FloatingActionButton(Part70.this);
        fab.setId(R.id.fab);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(answer_code.equals("CHAD45A")){
                    //general.CreateMainObjectInt("house_hold_sick_person", 1, Part70.this);
                    general.AddObjectToResultArray("CHAD45", answer_code, Part70.this);
                    Intent intent = new Intent(Part70.this, Part72.class);
                    intent.putExtra("TITLE", Title);
                    startActivity(intent);
                }else{
                    //general.CreateMainObjectInt("house_hold_sick_person", 0, Part70.this);
                    general.AddObjectToResultArray("CHAD45", answer_code, Part70.this);
                    Intent intent = new Intent(Part70.this, End.class);
                    intent.putExtra("TITLE", Title);
                    startActivity(intent);
                }
            }
        ...
        for(int i=0; i<questionnaire.length(); i++){
            ...
            if(CODES.contains(json_data.getString("code"))){
                ...
                RadioGroup rg = new RadioGroup(Part70.this);
                RadioButton spinner;
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                general.goBackDialoag(Part70.this);
            }
        });
    ...
    private void changeLanguageDialog(){
        ...
        new AlertDialog.Builder(Part70.this)
